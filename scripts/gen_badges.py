...
from markdown_badges import _text_color
...
def render() -> str:
    lines: list[str] = [
        ...
        "markdown_badges.levels]` (Zensical / MkDocs TOML) or into the "
    ...
    for category in Category:
        ...
        lines += ["", "```toml", "[project.markdown_extensions.markdown_badges.levels]"]
        for b in badges:
